...
export default function ProviderOverviewError({ error, reset }: ErrorProps) {
     useEffect(() => {
     ...
     return (
          <div className="mx-auto max-w-7xl px-4 py-16">
               <div className="glass-panel flex flex-col items-center justify-center rounded-2xl p-8 text-center border border-border">
                    ...
                    <h2 className="text-xl font-bold text-foreground">Failed to Load Dashboard Data</h2>
                    <p className="mt-2 max-w-md text-sm text-muted-foreground">
                         {error.message || 'There was an issue fetching your listed gear or rental statistics.'}
                    </p>
                    <button
                         onClick={() => reset()}
